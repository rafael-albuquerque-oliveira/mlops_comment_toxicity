...
train_ds = dataset.take(int(len(dataset)*.7))
val_ds = dataset.skip(int(len(dataset)*.7)).take(int(len(dataset)*.2))
test_ds = dataset.skip(int(len(dataset)*.9)).take(int(len(dataset)*.1))
